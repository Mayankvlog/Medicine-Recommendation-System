...
user_input = st.text_area("List your symptoms, separated by commas (e.g., headache, fever)")
...
if st.button("Predict Disease"):
    if not user_input:
        ...
        try:
            ...
            st.write(workout.to_string(index=False))

        except Exception as e:
            st.error(f"Error: {e}. Please ensure the symptoms are spelled correctly.")
